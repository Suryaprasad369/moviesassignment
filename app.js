...
app.get("/movies/", async (request, response) => {
  ...
  response.send(movieArray.map((moviename)=> convertMovieNametoPascalCase(moviename))
...
///3return a movie based movie Id
...
app.delete("/movies/:movieId/", async(request, response)=> {
    ...
    ///return a list of all specific director
